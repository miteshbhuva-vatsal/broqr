...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _t = {
    ...
    'en': {
      ...
      'pleaseSelectCategory': 'Please select a deal category.',
      'pleaseSelectCity': 'Please select your city.',
      'pleaseUploadHeroPhoto': 'Please upload at least one hero photo.',
      // Step 1 — Category
      'whatTypeDealPosting': 'What type of deal\nare you posting?',
      'chooseCategoryDesc': 'Choose the category that best describes your listing.',
      ...
      'marketPriceMrp': 'Market Price / MRP',
      'dealPrice': 'Deal Price (₹)',
      'askingPrice': 'Asking price',
      'optionalLabel': 'Optional',
      'requiredLabel': 'Required',
      'whoCanSee': 'Who can see this?',
      'priceStrikethroughHint': 'Set Market Price to show a strikethrough and savings badge on your listing.',
      'descriptionHint': 'Add any extra details — possession, floor, facing, amenities…',
      // Step 3 — Poster / images
      'createYourPoster': 'Create Your Poster',
      'uploadPhotosDesc': "Upload photos — we'll auto-generate a shareable poster.",
      'heroImageLabel': 'Hero Image',
      'heroImageSubtitle': 'Required · Main photo shown on poster',
      'tapToUploadHeroPhoto': 'Tap to upload hero photo',
      'jpgOrPng': 'JPG or PNG · max 5MB',
      'additionalPhotos': 'Additional Photos',
      'posterPreview': 'Poster Preview',
      'posterSharedWithListing': 'This will be shared with your listing',
      'autoGeneratedPoster': 'Auto-generated poster · editable in future updates',
      'cameraLabel': 'Camera',
      'galleryLabel': 'Gallery',
      'permissionDeniedSettings': 'permission denied. Enable it in Settings.',
      // Notifications
    ...
    'hi': {
      ...
      'selectCityTitle': 'शहर चुनें',
      'searchCityHint': 'शहर खोजें…',
      ...
      'listingPublishedSuccess': '🎉 लिस्टिंग सफलतापूर्वक प्रकाशित हुई!',
      'pleaseSelectCategory': 'कृपया एक डील श्रेणी चुनें।',
      'pleaseSelectCity': 'कृपया अपना शहर चुनें।',
      'pleaseUploadHeroPhoto': 'कृपया कम से कम एक मुख्य फोटो अपलोड करें।',
      'whatTypeDealPosting': 'आप किस प्रकार की डील\nपोस्ट कर रहे हैं?',
      'chooseCategoryDesc': 'वह श्रेणी चुनें जो आपकी लिस्टिंग का सबसे अच्छा वर्णन करती है।',
      ...
      'marketPriceMrp': 'बाज़ार मूल्य / MRP',
      'dealPrice': 'डील मूल्य (₹)',
      'askingPrice': 'मांग मूल्य',
      'optionalLabel': 'वैकल्पिक',
      'requiredLabel': 'आवश्यक',
      'whoCanSee': 'इसे कौन देख सकता है?',
      'priceStrikethroughHint': 'बाज़ार मूल्य सेट करें ताकि आपकी लिस्टिंग पर स्ट्राइकथ्रू और बचत बैज दिखे।',
      'descriptionHint': 'अतिरिक्त विवरण जोड़ें — कब्ज़ा, मंजिल, दिशा, सुविधाएं…',
      'createYourPoster': 'अपना पोस्टर बनाएं',
      'uploadPhotosDesc': 'फोटो अपलोड करें — हम स्वचालित रूप से एक शेयर करने योग्य पोस्टर बनाएंगे।',
      'heroImageLabel': 'मुख्य फोटो',
      'heroImageSubtitle': 'आवश्यक · पोस्टर पर दिखाई जाने वाली मुख्य फोटो',
      'tapToUploadHeroPhoto': 'मुख्य फोटो अपलोड करने के लिए टैप करें',
      'jpgOrPng': 'JPG या PNG · अधिकतम 5MB',
      'additionalPhotos': 'अतिरिक्त फोटो',
      'posterPreview': 'पोस्टर पूर्वावलोकन',
      'posterSharedWithListing': 'यह आपकी लिस्टिंग के साथ शेयर किया जाएगा',
      'autoGeneratedPoster': 'स्वत: निर्मित पोस्टर · भविष्य के अपडेट में संपादन योग्य',
      'cameraLabel': 'कैमरा',
      'galleryLabel': 'गैलरी',
      'permissionDeniedSettings': 'अनुमति अस्वीकृत। सेटिंग्स में सक्षम करें।',
      // Notifications
    ...
    'gu': {
      ...
      'selectCityTitle': 'શહેર પસંદ કરો',
      'searchCityHint': 'શહેર શોધો…',
      ...
      'stepCategory': 'કેટેગરી',
      'stepDetails': 'વિગત',
      'stepPoster': 'પોસ્ટર',
      'nextArrow': 'આગળ →',
      'publishListing': '🚀  લિસ્ટિંગ પ્રકાશિત કરો',
      'listingPublishedSuccess': '🎉 લિસ્ટિંગ સફળતાપૂર્વક પ્રકાશિત થઈ!',
      'pleaseSelectCategory': 'કૃપા કરીને ડીલ કેટેગરી પસંદ કરો.',
      'pleaseSelectCity': 'કૃપા કરીને તમારું શહેર પસંદ કરો.',
      'pleaseUploadHeroPhoto': 'કૃપા કરીને ઓછામાં ઓછો એક મુખ્ય ફોટો અપલોડ કરો.',
      'whatTypeDealPosting': 'તમે કેવા પ્રકારની ડીલ\nપોસ્ટ કરી રહ્યા છો?',
      'chooseCategoryDesc': 'તે કેટેગરી પસંદ કરો જે તમારી લિસ્ટિંગનું સૌથી સારું વર્ણન કરે.',
      ...
      'areaRequired': 'ક્ષેત્રફળ જરૂરી છે',
      'marketPriceMrp': 'બજાર ભાવ / MRP',
      'dealPrice': 'ડીલ ભાવ (₹)',
      'askingPrice': 'માંગ ભાવ',
      'optionalLabel': 'વૈકલ્પિક',
      'requiredLabel': 'જરૂરી',
      'whoCanSee': 'આ કોણ જોઈ શકે?',
      'priceStrikethroughHint': 'બજાર ભાવ સેટ કરો જેથી તમારી લિસ્ટિંગ પર સ્ટ્રાઇકથ્રૂ અને બચત બેજ દેખાય.',
      'descriptionHint': 'વધારાની વિગત ઉમેરો — કબ્જો, માળ, દિશા, સુવિધાઓ…',
      'createYourPoster': 'તમારો પોસ્ટર બનાવો',
      'uploadPhotosDesc': 'ફોટો અપલોડ કરો — અમે આપોઆપ શેર કરી શકાય તેવો પોસ્ટર બનાવીશું.',
      'heroImageLabel': 'મુખ્ય ફોટો',
      'heroImageSubtitle': 'જરૂરી · પોસ્ટર પર દેખાતો મુખ્ય ફોટો',
      'tapToUploadHeroPhoto': 'મુખ્ય ફોટો અપલોડ કરવા ટૅપ કરો',
      'jpgOrPng': 'JPG અથવા PNG · મહત્તમ 5MB',
      'additionalPhotos': 'વધારાના ફોટો',
      'posterPreview': 'પોસ્ટર પૂર્વાવલોકન',
      'posterSharedWithListing': 'આ તમારી લિસ્ટિંગ સાથે શેર કરવામાં આવશે',
      'autoGeneratedPoster': 'આપોઆપ બનેલ પોસ્ટર · ભવિષ્યના અપડેટ્સમાં સંપાદનક્ષમ',
      'cameraLabel': 'કૅમેરા',
      'galleryLabel': 'ગૅલેરી',
      'permissionDeniedSettings': 'પરવાનગી નકારી. સેટિંગ્સમાં સક્ષમ કરો.',
      // Notifications
  ...
  String get selectCityTitle => _s('selectCityTitle');
  String get searchCityHint => _s('searchCityHint');
  ...
  String get stepCategory => _s('stepCategory');
  String get stepDetails => _s('stepDetails');
  String get stepPoster => _s('stepPoster');
  String get nextArrow => _s('nextArrow');
  String get publishListing => _s('publishListing');
  String get listingPublishedSuccess => _s('listingPublishedSuccess');
  String get pleaseSelectCategory => _s('pleaseSelectCategory');
  String get pleaseSelectCity => _s('pleaseSelectCity');
  String get pleaseUploadHeroPhoto => _s('pleaseUploadHeroPhoto');
  String get whatTypeDealPosting => _s('whatTypeDealPosting');
  String get chooseCategoryDesc => _s('chooseCategoryDesc');
  ...
  String get locationRequired => _s('locationRequired');
  String get areaRequired => _s('areaRequired');
  String get marketPriceMrp => _s('marketPriceMrp');
  String get dealPrice => _s('dealPrice');
  String get askingPrice => _s('askingPrice');
  String get optionalLabel => _s('optionalLabel');
  String get requiredLabel => _s('requiredLabel');
  String get whoCanSee => _s('whoCanSee');
  String get priceStrikethroughHint => _s('priceStrikethroughHint');
  String get descriptionHint => _s('descriptionHint');
  String get createYourPoster => _s('createYourPoster');
  String get uploadPhotosDesc => _s('uploadPhotosDesc');
  String get heroImageLabel => _s('heroImageLabel');
  String get heroImageSubtitle => _s('heroImageSubtitle');
  String get tapToUploadHeroPhoto => _s('tapToUploadHeroPhoto');
  String get jpgOrPng => _s('jpgOrPng');
  String get additionalPhotos => _s('additionalPhotos');
  String get posterPreview => _s('posterPreview');
  String get posterSharedWithListing => _s('posterSharedWithListing');
  String get autoGeneratedPoster => _s('autoGeneratedPoster');
  String get cameraLabel => _s('cameraLabel');
  String get galleryLabel => _s('galleryLabel');
  String get permissionDeniedSettings => _s('permissionDeniedSettings');
  // Notifications
